...
const Header = (props) => {
  ...
  const routes = [
    ...
    // { name: "Categories", link: "/categories", activeIndex: 1 },
    ...
    //   activeIndex: 2,
    // },
    { name: "Fleet", link: "/", activeIndex: 0 },
    // { name: "Vehicles", link: "/products", activeIndex: 3 },
    { name: "Routes", link: "/cities", activeIndex: 1 },
    { name: "Users", link: "/users", activeIndex: 2 },
    { name: "Orders", link: "/orders", activeIndex: 3 },
    { name: "Trips", link: "/trips", activeIndex: 4 },
    { name: "Payments", link: "/payments", activeIndex: 5 },
    { name: "Remittances", link: "/remittances", activeIndex: 6 },

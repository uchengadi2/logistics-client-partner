  ...
  const renderVehiclePermanentAddressField = ({
    ...
    return (
      <TextField
        ...
        label={label}
        id={input.name}
        value={params.vehicleLocationAddress}
        fullWidth
        type={type}
        style={{ marginTop: 20 }}
        multiline={true}
  ...
  const renderLatituteField = ({
    ...
    return (
      <TextField
        ...
        variant="outlined"
        label={label}
        id={params.vehicleLocationLatitude}
  ...
  const renderLongtituteField = ({
    ...
    return (
      <TextField
        ...
        label={label}
        id={input.name}
        value={params.vehicleLocationLongtitude}
        fullWidth
        //required
        type={type}
        {...custom}
  ...
  const renderVehicleChassisField = ({
    ...
    return (
      <TextField
        ...
        label={label}
        id={input.name}
        value={params.vehicleChassisNumber}
        fullWidth
        //required
        type={type}
        {...custom}
